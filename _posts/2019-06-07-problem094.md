...
II - 2. Morris traversal with Threaded Binary Tree. It is easy, actually, convert the binary tree to a line first, then add value of current node one by one into result list.      
